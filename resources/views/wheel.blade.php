    ...
    <script>
        let theWheel = new Winwheel({
            ...
            [                               // font size and test colour overridden on backrupt segments.
               {'fillStyle' : '#ee1c24', 'text' : '500'},
               {'fillStyle' : '#3cb878', 'text' : '750'},
               {'fillStyle' : '#f6989d', 'text' : '1000'},
               {'fillStyle' : '#00aef0', 'text' : '1500'},
               {'fillStyle' : '#f26522', 'text' : '2000'}
            ],
        ...
        function startSpin()
        {
            ...
            if (wheelSpinning == false) {
                ...
                document.getElementById('spin_button').className = "disabled:opacity-50";
